            ...
            <div className="container flex mx-auto justify-between mt-14">
                <div className="w-3/4">
                    <div className="flex justify-between">
                        ...
                        <button className="bg-[#123E59] rounded-full w-1/5 text-white relative flex justify-center items-center">
                    ...
                    <div className="rounded-2xl border-[1px] border-black mt-6">
                        ...
                        <div className="flex px-6 my-4"  >
                            <button className="text-[#123E59] font-bold border-black border-[1px] rounded-full px-3 py-1 hover:text-[#FFFFFF] hover:bg-[#123E59] focus:bg-[#123E59] focus:text-white active:bg-[#123E59] mr-4">Active Jobs</button>
